...
class DayNoteForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'quiz_score': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': '0', 'step': 'any'}),
            'quiz_max': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': '10', 'step': 'any'}),
